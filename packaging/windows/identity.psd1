...
@{
    ...
    #
    #   Get-AppxPackage Excelano.Duckling
    #   https://apps.microsoft.com/detail/9P4V2XZ0J2Z2
    PackageFamilyName = 'Excelano.Duckling_nbxmgv0sk86m4'
    StoreId = '9P4V2XZ0J2Z2'
}
