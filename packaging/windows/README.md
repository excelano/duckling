...
`shots.ps1` does this and reads the family name out of `identity.psd1`.
...
| `shots.ps1` | The listing's two frames as recipes: which documents, which state, and what happens before each shutter |
